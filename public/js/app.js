...
/* harmony import */ var _sample_monsters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sample-monsters */ "./resources/js/sample-monsters.js");

window.EncounterBuilder = _encounter_builder__WEBPACK_IMPORTED_MODULE_0__;

window.SampleMonsters = _sample_monsters__WEBPACK_IMPORTED_MODULE_1__;
...
/***/ "./resources/js/sample-monsters.js":
/*!*****************************************!*\
  !*** ./resources/js/sample-monsters.js ***!
  \*****************************************/
...
var monsters = [{
  ...
  "damageResistances": ["fire", "cold", "lightning", "physical_non_magical"],
  "damageImmunities": ["poison"],
  "damageVulnerabilites": [],
  "conditionImmunities": ["poisoned"],
  "skills": [],
  ...
  "features": {
    ...
    "action": [{
      ...
      "aoeRange": 30,
      "savingThrowMonsterAbility": "str",
      "savingThrowSaveAbilities": ["str", "dex"],
      "savingThrowDamage": [{
        "diceType": 6,
        "diceAmount": 6,
        "additional": 0,
...
/***/ "./resources/js/statblock-feature.js":
/*!*******************************************!*\
  !*** ./resources/js/statblock-feature.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StatBlockFeature; });
/* harmony import */ var _vueform_multiselect_dist_multiselect_vue2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @vueform/multiselect/dist/multiselect.vue2.js */ "./node_modules/@vueform/multiselect/dist/multiselect.vue2.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var StatBlockFeature = {
    ...
    value: {
      handler: function handler(val) {
        ...
        if (!this.$parent.$parent.f5.areaofeffect[this.value.targetType].types.includes(this.value.template)) {
          for (var key in this.$parent.$parent.f5.areaofeffect) {
            var element = this.$parent.$parent.f5.areaofeffect[key];
  ...
  computed: {
    featureReferences: function featureReferences() {
    ...
    calcAverageDPR: function calcAverageDPR() {
      var avgDPR = 0;
      var avgTargets = 1;
      ...
      if (this.value.manualDPR >= 0) {
        ...
        if (this.value.attackSavingThrow) {
          for (var _i2 in this.value.savingThrowDamage) {
            avgDPR += this.$parent.averageDamage(this.value.savingThrowDamage[_i2], 0);
          }
        }

        avgTargets = this.value.attackTargets; //Include average AC and chance to hit?? Average ~16
      } else if (this.value.template === 'saving_throw') {
        // Saving Throw Average DPR
        for (var _i3 in this.value.savingThrowDamage) {
          avgDPR += this.$parent.averageDamage(this.value.savingThrowDamage[_i3], 0);
        }

        var distanceBaseline = 30;
        ...
        var _iterator3 = _createForOfIteratorHelper(this.value.multiattackReferences),
            _step3;

        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var maGroup = _step3.value;
            var groupDPR = 0;

            var _iterator4 = _createForOfIteratorHelper(maGroup),
                _step4;

            try {
              for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                var featureRef = _step4.value;
    ...
    getValidTemplateTypes: function getValidTemplateTypes() {
      ...
      for (var i in this.$parent.$parent.f5.featuretemplates) {
        if (this.$parent.$parent.f5.featuretemplates[i].action_options && this.$parent.$parent.f5.featuretemplates[i].action_options.includes(this.value.actionType)) {
    ...
    spellsUsesSorted: function spellsUsesSorted() {
      ...
      var _iterator8 = _createForOfIteratorHelper(this.value.spellList),
          _step8;

      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var spell = _step8.value;
    ...
    multiattackDescription: function multiattackDescription() {
      ...
      var maAbilityDescs = [[], []]; // Multiattacks will only have 2 options

      for (var i in this.value.multiattackReferences) {
        var group = this.value.multiattackReferences[i];
        var prevTemplate = '';

        for (var j in group) {
          var featureRef = group[j];
          var featDesc = this.$parent.$parent.f5.misc.desc_multiattack_ability;
          var feature = void 0;
          ...
          if (featureRef.index !== null) {
            if (featureRef.index === 'spellcasting') {
              ...
              if (feature.template === 'attack') {
                var attackString = this.$parent.pluralize(this.$parent.$parent.f5.misc.attack, featureRef.uses);
                var attackSingular = this.$parent.pluralize(this.$parent.$parent.f5.misc.attack);
                var attackPlural = this.$parent.pluralize(this.$parent.$parent.f5.misc.attack, 2);
    ...
    savingThrowDescription: function savingThrowDescription() {
      ...
      if (this.value.savingThrowDamage.length) {
        ...
        for (var i in this.value.savingThrowDamage) {
      ...
      if (this.value.savingThrowConditions.length) {
        ...
        for (var _i5 in this.value.savingThrowConditions) {
          stConditionList.push(this.$parent.pluralize(this.$parent.$parent.f5.conditions[this.value.savingThrowConditions[_i5]].is, stTargetCount).replace(':condition', this.$parent.$parent.f5.conditions[this.value.savingThrowConditions[_i5]].name.toLowerCase()));
          stNotConditionList.push(this.$parent.pluralize(this.$parent.$parent.f5.conditions[this.value.savingThrowConditions[_i5]].not, stTargetCount).replace(':condition', this.$parent.$parent.f5.conditions[this.value.savingThrowConditions[_i5]].name.toLowerCase())); //TODO replace distance for pushed
        }
    ...
    damageProjection: function damageProjection() {
      var turnDamage = [];
      var averageRechargeTurns = 1; //Spellcasting Projections

      if (this.value.template === 'spellcasting') {
        var spellSlotsTracker = [];

        var _iterator9 = _createForOfIteratorHelper(this.value.spellList),
            _step9;

        try {
          spellLoop: for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            var spell = _step9.value;
    ...
    multiattackMatches: function multiattackMatches() {
      var maMatches = [];
      var maUnique = [];
  ...
  methods: {
    addDamageDie: function addDamageDie(type) {
      var damageDie = this.$parent.createDamageDie(this.value[type].length > 0 ? false : true); //false for each damage set after the first
    ...
    addSpell: function addSpell() {
      var spellLevel = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    ...
    removeSpell: function removeSpell(spellIndex) {
    ...
    compareIdToMultiattackFeatures: function compareIdToMultiattackFeatures(obj) {
      ...
      var _iterator12 = _createForOfIteratorHelper(this.value.multiattackReferences),
          _step12;
...
var StatBlock = {
  ...
  components: {
    'multiselect': _vueform_multiselect_dist_multiselect_vue2_js__WEBPACK_IMPORTED_MODULE_0__["default"],
    'statblock-feature': _statblock_feature_js__WEBPACK_IMPORTED_MODULE_1__["default"] //'projection-graph': ProjectionGraph,
  ...
  methods: {
    ...
    exportMonster: function exportMonster() {
      var cloneOptions = JSON.parse(JSON.stringify(this.value)); //delete cloneOptions.averageDPR;
      ...
      for (var featureType in cloneOptions.features) {
        ...
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {//delete feature.averageDPR;
